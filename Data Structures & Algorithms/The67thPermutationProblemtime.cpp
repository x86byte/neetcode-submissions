...
void solve() {
    ...
    // To match your exact example 3 (n=3): 5 2 4 8 3 9 7 1 6
    // It uses a specific alternating pattern.
    // However, the simplest greedy way to get the MAX sum is:
    vector<int> p;
    int small = 1;
    int large_low = n + 1;
    int large_high = n + 2;
    ...
    for (int i = 0; i < n; i++) {
        cout << small << " " << large_low << " " << large_high << " ";
        small++;
        large_low += 2;
        large_high += 2;
    }
